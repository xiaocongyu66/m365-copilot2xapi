...
const linkedAccountValidator = hasShape({ id: isString, provider: isOneOf("m365_copilot"), name: isString, email: isOptional(isString), userId: isOptional(isString) });
const accountValidator = hasShape({
  id: isString, provider: isOneOf("m365_copilot"), authType: isOneOf("oauth"), webTier: isOptional(isOneOf("auto", "basic", "super", "heavy")),
  ...
  linkedAccountId: isOptional(isString), linkedAccountName: isOptional(isString), linkedProvider: isOptional(isOneOf("m365_copilot")), linkedAccounts: isOptional(isArrayOf(linkedAccountValidator)),
